...
|---|---|---|---|
| **Grant** | What the credential technically permits | The party acting | The system issuing the credential |
| **Mandate** | What the party is authorised and expected to do | The party acting, as a statement | **Usually nothing** |
...
| # | Claim |
|---|-------|
| 1 | A grant is what a credential permits; a mandate is what the holder is authorised and expected to do |
| 2 | Grant is already the corpus's word for a capability and needs no replacement |
| 3 | The 17 July claim that to grant is to mandate is corrected: they coincide only in the rare case |
| 4 | What that brief got right stands, since a party carries the exposure of whatever it was handed |
