...
PACKS = [
 dict(slug="registry-mvp",
  ...
  one_line="A public key registry on vaults — open data, one operator, and LLM sessions as the first users on both sides. 8 documents.",
  meta_desc="The registry MVP pack, readable in-page: the leading brief, architecture, schemas, workflows, build order, diagrams, change control and the tabletop exercise.",
