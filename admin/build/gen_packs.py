...
""",
 ...
 dict(slug="grant-and-mandate",
  ...
  dl_blurb="",
  one_line="Building blocks for the RiskMandate product: a grant measured, a mandate authored, the delta between them, and a library of measured grants. Nine documents plus change control, two measured library entries, and build-order step 1 built: a push refused by git, not by the agent. Document 08 is the build record — what shipped, and what is still only written down. The registry holds the library (no personal data ever); the risk product holds the instance, storing references not copies.",
