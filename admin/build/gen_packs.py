...
""",
 ...
 dict(slug="grant-and-mandate",
  ...
  docs=[
   ...
   dict(slug="change-control", file="99__change-control.md",
    title="Appendix — Change control",
    role="Sixteen corrections, twenty-nine decisions, the release the control refused, and the defects the second measurement found",
