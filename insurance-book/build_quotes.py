...
CONTENT = ROOT / "insurance-book" / "content"
...
CANDIDATES = []
for pat in ("briefs/v0.33.7*.md", "briefs/v0.33.8*.md",
            "briefs/v0.33.5*.md", "briefs/v0.33.6*.md", "insurance/src/*.md",
            "insurance/llms.txt", "insurance/insurance.json",
            "packs/*/src/*.md", "registry/llms.txt", "registry/*.json",
            "registry/views/*.json", "llms.txt", "bench/llms.txt",
            "insurance-book/BRIEF.md", "book/content/*.md", "book/llms.txt",
...
(ROOT / "insurance-book" / "quotes.json").write_text(json.dumps(out, indent=2, ensure_ascii=False) + "\n")
